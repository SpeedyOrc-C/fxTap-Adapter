...
data OsuHitObject
    ...
    | HitObjectSlider
        ...
        , timeHitObject :: Integer
        , hitSound :: HitSound
        , sliderCurveType :: SliderCurveType
        , sliderCurvePoints :: [(Integer, Integer)]
        , sliderSlides :: Integer
        , sliderLength :: Double
        , sliderEdgeSounds :: [Integer]
        , slidesEdgeSets :: [(HitSound, HitSound)]
        , hitSample :: HitSample
        }
    deriving (Show)
    ...
    getINoteColumns (Osu{hitObjects, difficulty}) =
      ...
      where
        ...
        convert = \case
            ...
            o -> error $ "This osu! object can't be converted: " ++ show o
